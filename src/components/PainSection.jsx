export default function PainSection() {
  return (
    <section className="bg-white text-black py-10 md:py-24 px-5 md:px-4" dir="rtl">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-2xl md:text-4xl font-black text-gray-900 mb-6">
            זו לא אשמתך..
          </p>
        ...
        {/* Turning point */}
        <div className="mb-12">
          <p className="text-xl md:text-3xl font-black text-gray-900 mb-4">
        ...
        <div>
          ...
          <div className="flex justify-center mt-8">
            <img
              ...
              alt="עמיחי שקל"
              className="rounded-2xl max-w-[280px] md:max-w-md w-full shadow-lg"
            />
          </div>
        </div>
      </div>
