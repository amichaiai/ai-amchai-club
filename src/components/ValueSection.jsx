    ...
    <section className="py-10 md:py-24 bg-white text-black">
      <div className="max-w-3xl mx-auto px-4 text-center">
        ...
        <p className="text-lg md:text-xl mb-1">
          בעולמות ה-AI שלכל כלי כזה יש פוטנציאל
        </p>

        <p className="text-lg md:text-xl font-bold mb-8">
          לחסוך לכם עשרות אלפי שקלים ועשרות שעות של עבודה
        </p>

        <p className="text-lg md:text-xl mb-1">
          תיחשפו לכל הכלים המתקדמים ביותר,
        </p>

        <p className="text-lg md:text-xl mb-1">
          עם השיטות להשתמש בהם לפני כולם,
        </p>

        <p className="text-lg md:text-xl mb-1">תכירו את השיטה שעזרה לי</p>
