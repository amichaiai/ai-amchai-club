export default function PricingSection() {
  return (
    <section className="py-10 md:py-24 bg-black text-white text-center">
      <div className="max-w-3xl mx-auto px-5 md:px-4">
        ...
        <h2 className="text-xl md:text-4xl font-bold mb-6 leading-snug">
          ...
          <span className="text-gradient-blue text-3xl md:text-6xl font-black block mt-2">
            6,000&#8362;
          </span>{' '}
        ...
        <img
          ...
          alt="הוכחת הרצאות"
          className="max-w-sm md:max-w-lg w-full mx-auto rounded-lg mb-8"
        />
        ...
        {/* Monthly price */}
        <p
          className="text-3xl md:text-6xl font-black mb-6 line-through"
          style={{
            textShadow:
        ...
        {/* Special offer text */}
        <p className="text-white text-base md:text-xl font-bold mb-6 max-w-2xl mx-auto leading-relaxed">
        ...
        {/* Giant launch price */}
        <p
          className="text-4xl md:text-7xl font-black mb-8 animate-glow"
          style={{
            textShadow:
        ...
        <div className="animate-float">
          <img
            ...
            alt="10 שקלים"
            className="max-w-[180px] md:max-w-xs w-full mx-auto"
          />
        </div>
      </div>
    </section>
